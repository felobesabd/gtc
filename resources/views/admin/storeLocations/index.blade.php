    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-8 col-auto">
                <h3 class="page-title">Store Locations</h3>
            </div>

            <div class="col-sm-4 col">
                <a href="{{route('admin.storeLocations.create')}}" class="btn btnColor float-end mt-2">Add Store Location</a>
            </div>
        </div>
    </div>
...
<script>
    ...
    var ajax_url = "{!! route('admin.storeLocations.data-table') !!}";

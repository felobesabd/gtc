    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-8 col-auto">
                <h3 class="page-title">Incidental Expenses</h3>
            </div>

            <div class="col-sm-4 col">
                <a href="{{route('admin.expenses.create')}}" class="btn btnColor float-end mt-2">Add Incidental Expense</a>
            </div>
        </div>
    </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 ajax-data-table">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Operation Type</th>
...
<script>
    ...
    var ajax_url = "{!! route('admin.expenses.data-table') !!}";

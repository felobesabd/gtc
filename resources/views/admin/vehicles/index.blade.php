    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-sm-4 col">
                <a href="{{route('admin.vehicles.create')}}" class="btn btnColor float-end mt-2">Add Vehicle</a>
            </div>
        </div>
    </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 ajax-data-table">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Chassis No</th>
                        <th class="min-w-125px">Gearbox No</th>
                        <th class="min-w-125px">Machine No</th>
                        <th class="min-w-125px">Plate No</th>
                        <th class="min-w-125px">License No</th>
...
<script>
    ...
    var ajax_url = "{!! route('admin.vehicles.data-table') !!}";
